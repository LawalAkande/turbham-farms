    ...
    <>
      {isSmallScreen ? (
        <header className="relative w-[100%] h-[100%]">
          <Image
            src="/assets/images/paas/paasMobile.png"
            alt="Hero Image"
            width={0}
            height={0}
            sizes="100vw"
          ...
          />
          <h5 className="absolute top-[5%] left-[31%] translate-x-[-50%] translate-y-[-35%] font-windsorpro-bold  text-AquaDeep text-[34px] leading-[2.5rem]">
            Our Services
          </h5>
          <p className="absolute top-[27%] left-[40%] translate-x-[-50%] translate-y-[-50%] text-xs font-medium leading-[0.975rem]">
        ...
        <header className="relative w-[100%] h-[100%] px-[27px]">
          <Image
            src="/assets/images/paas/paas1.png"
            alt="Hero Image"
            width={0}
            height={0}
            sizes="100vw"
          ...
          <h5 className="absolute top-[15%] left-[27%] translate-x-[-50%] translate-y-[-50%] font-windsorpro-bold  text-7xl text-AquaDeep leading-[5.29rem] max-lg:text-[34px] max-lg:leading-[2.5rem]">
            Our Services
          </h5>
